...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
           		<form method="get" action="/user/user.do">
					<input name="method" value="query" class="input-text" type="hidden">
					 <span>用户名：</span>
					 <input name="userName" class="input-text"	type="text" value="${queryUserName }"/>
					 <span>用户角色：</span>
						<c:if test="${roleList != null }"><select name="userRole">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${pageBean.pageIndexList}" varStatus="status">
					<tr>
						<td>
			...
			<%--导入rollpage页面 实现分页跳转--%>
		  	<c:import url="rollpage.jsp">
	          	...
	          	<c:param name="pageIndex" value="${pageBean.pageIndex}"/>
	          	<c:param name="totalPageCount" value="${pageBean.totalPageCount}"/>
          	</c:import>
			<div class="userAdd">
				<div>
