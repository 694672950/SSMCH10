...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>营业执照：</strong><img src="${pageContext.request.contextPath}/${provider.proPath}"></p>
            <p><strong>工作照：</strong><img src="${pageContext.request.contextPath}/${provider.workPath}"></p>
