...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
  ...
  <div class="right">
      ...
      <div class="providerAdd">
          <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/modify.do">
              ...
              <div class="">
                  ...
                  <input type="hidden" name="createdBy" id="createdBy" value="${provider.createdBy}">
                  <input type="hidden" name="creationDate" id="creationDate" value="${provider.creationDate}">
                  <input type="hidden" name="modifyBy" id="modifyBy" value="${provider.modifyBy}">
                  <input type="hidden" name="creationDate" id="modifyDate" value="${provider.modifyDate}">
                  <input type="hidden" name="proPath" id="proPath" value="${provider.proPath}">
              </div>
              <div>
